...
const kApiKeyGoogleSheets = 'AIzaSyB-jU4XlYw45Txw61ci2fVtU1fmh5mCnx4';

const kGoogleSheetUrlCategories =
    'https://sheets.googleapis.com/v4/spreadsheets/1EBxY6YBID5V-43UckKyYeIgDpAjfSkXUTNOtX52oHOs/values/Categories!A1:K15?majorDimension=COLUMNS&key=AIzaSyB-jU4XlYw45Txw61ci2fVtU1fmh5mCnx4';

const kGoogleSheetUrlTournaments =
    'https://sheets.googleapis.com/v4/spreadsheets/1EBxY6YBID5V-43UckKyYeIgDpAjfSkXUTNOtX52oHOs/values/Tournaments!B1:B3?majorDimension=COLUMNS&key=AIzaSyB-jU4XlYw45Txw61ci2fVtU1fmh5mCnx4';

const kGoogleSheetUrlJudges =
    'https://sheets.googleapis.com/v4/spreadsheets/1EBxY6YBID5V-43UckKyYeIgDpAjfSkXUTNOtX52oHOs/values/Judges!B1:K3?majorDimension=COLUMNS&key=AIzaSyB-jU4XlYw45Txw61ci2fVtU1fmh5mCnx4';

const kNewsFeedUrl = 'http://www.keflavik.is/resources/json/skotdeild.aspx';

const kRegistrationEmail = 'skot@keflavik.is';
